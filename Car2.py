...
class Car:
    ...
    def update(self):
        ...
        self.accelerating = False  # Reset the flag
    ...
    def perform_drift(self):
        ...
        # Introduce a smooth factor to reduce the abrupt changes in speed
        smoothing_factor = 0.8
        self.speed = (1 - smoothing_factor) * self.speed + smoothing_factor * (self.speed - self.speed * self.friction * drift_factor)
        
        # Smoothen the change in velocity as well
        new_velocity = self.direction * self.speed + ortho_direction * self.speed * drift_factor
        self.velocity = (1 - smoothing_factor) * self.velocity + smoothing_factor * new_velocity
